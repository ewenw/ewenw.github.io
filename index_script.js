...
const nodes = [ 
  ...
  { id: "rocket", link: "https://play.google.com/store/apps/details?id=com.ween.rocket&hl=en_US", label: "Land the Rocket", level: 3 , description: "Experience the thrill of landing a reusable orbital booster on a drone ship in the middle of the ocean."},
  { id: "evorite", link: "https://play.google.com/store/apps/details?id=com.complex51.evorite", label: "Evorite", level: 3 , description: "Explore the mysteries of the solar system through breathtaking graphics"},
  { id: "swipe", link: "https://play.google.com/store/apps/details?id=com.weengames.smashballistics", label: "Swipe Ballistics", level: 3 , description: "Master ballistic physics and throw projectiles to get through obstacles"},
  ...
  { id: "hackdartmouth", link: "https://github.com/ewenw/YelpMyProfessors", label: "YelpMyProfessors", level: 4, description: "Tired of reading reviews? Just paste them in for an overall rating!"},
  { id: "nodegame", link: "https://nodegame.org", label: "nodeGame", level: 4, description: "Fast, scalable JavaScript for large-scale, online, multiplayer, real-time games and experiments"}
